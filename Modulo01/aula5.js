...
console.log(1.2);
console.log(7);
console.log(1000, 1520.10, "Leonardo"); //nesse caso não quebrará linha

// Exercício 1 - Apresente no console a seguinte mensagem: Meu nome é "NOME" e estou na aula de sábado com o professor Jaques.
console.log("Meu nome é Leonardo e estou na aula ", 0o5, " do o professor Jaques");
...
nome = "Leonardo"; // caso não seja especificado, criará uma variável global, n deve ser utilizada
let nome = "Leonardo"; //declaração padrão
var name = "Leonardo"; //bastante antigo
...
const autenticacao = usuario === 'Leonardo' && senha === '12345';
